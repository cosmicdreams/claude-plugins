...
Agents go idle after every turn — this is normal, not an error. An idle agent is waiting for input; sending it a message wakes it. Do not poke idle agents unless you have work or a question for them.

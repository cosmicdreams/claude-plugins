...
description: >
  ...
  workflow:prioritize. Designed to run on a loop. Renamed from ecosystem-pulse.
...
# workflow:scout — Knowledge Radar
...
Sources and the interest profile live in `~/.claude/workflow.json` under a `scout` block (sources,

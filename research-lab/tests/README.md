...
learner, and evaluator results. They do not need real `nlm` authentication,
...
model obeys the learner's evidence boundary, or address experiment rollback
ownership or all setup/dedup failures.
